...
function red_starter_scripts() {
	...
	wp_enqueue_style( 'red-starter-font-awesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.9.0/css/all.css');
	wp_enqueue_script( 'red-starter-search-form', get_template_directory_uri() . '/build/js/search-form.min.js', array(), null, true );
